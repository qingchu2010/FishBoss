        ...
        <div class="drawer-content">
          ...
          <div class="setting-section">
            ...
            <div class="language-selector">
              <button type="button" class="lang-trigger" @click="toggleDropdown">
                <Globe :size="18" />
...
const currentLanguage = computed(() => languages.find((item) => item.value === locale.value))
...
function selectLanguage(newLocale: 'zh_CN' | 'en'): void {
  if (props.persist) {
    setLocale(newLocale)
  } else {
